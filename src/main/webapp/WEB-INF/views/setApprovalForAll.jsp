    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <div class="list-group">
                ...
                <a href="/standard/setApprovalForAll" class="list-group-item active">운영자 추가/삭제</a>
        ...
        <div class="col-lg-9">
            <div class="card card-outline-secondary my-4">
                <div class="card-header">
                    <h1>운영자 추가/삭제</h1>
                    <h2>표준 SDK의 setApprovalForAll 함수</h2>
                </div>
                <div class="card-body">
                    <table width="780">
                        <tr>
                            ...
                            <td>
                                추가(true)/삭제(false): <input type="text" id="approved">
                            </td>
                            <td align="right">
                                <input type="submit" class="btn btn-success" value="submit" onclick="setApprovalForAll()">
                            </td>
                        </tr>
                    </table>
                </div>
...
<script>
    function setApprovalForAll() {
        ...
        $.ajax({
            type: "POST",
            url: "/standard/setApprovalForAll",
            data: {
                "ownerKey":  ownerKey,
