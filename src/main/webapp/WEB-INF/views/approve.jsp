    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <div class="list-group">
                ...
                <a href="/standard/approve" class="list-group-item active">토큰 피승인자 설정</a>
                ...
                <div class="card-body">
                    <table width="780">
                        <tr>
                            ...
                            <td>
                                피승인자 ID: <input type="text" id="approvedId">
                            </td>
                            <td>
                                토큰 ID: <input type="text" id="tokenId">
                            </td>
                            <td align="right">
                                <input type="submit" class="btn btn-success" value="submit" onclick="approve()">
                            </td>
                        </tr>
                    </table>
                </div>
...
<script>
    function approve() {
        ...
        approvedId = document.getElementById("approvedId").value;
