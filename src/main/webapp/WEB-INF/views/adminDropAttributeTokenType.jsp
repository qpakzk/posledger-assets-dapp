    ...
    <div class="row">
        ...
        <div class="card card-outline-secondary my-4">
            <div class="card-header">
                <h1>Drop Attribute Token Type </h1>
            ...
            <div class="card-body" algin="right">
                ...
                <table width="780">
                    <tr>
                        ...
                        <td align="right">
                            <input type="submit" class="btn btn-success" value="submit" onclick="dropAttributeTokenType()">
                        </td>
                    </tr>
                </table>
                <hr>
...
<script >
    function dropAttributeTokenType() {
