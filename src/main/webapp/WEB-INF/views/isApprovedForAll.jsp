    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <div class="list-group">
                ...
                <a href="/standard/isApprovedForAll" class="list-group-item active">운영자 여부 조회</a>
            </div>
        </div>
        <div class="col-lg-9">
            <div class="card card-outline-secondary my-4">
                <div class="card-header">
                    <h1>운영자 여부 조회</h1>
                    <h2>표준 SDK의 isApprovedForAll 함수</h2>
                </div>
                <div class="card-body">
                    <table width="780">
                        <tr>
                            <td>
                                소유자 ID: <input type="text" id="ownerId">
                            </td>
                            <td>
                                운영자 ID: <input type="text" id="operatorId">
                            </td>
                            <td align="right">
                                <input type="submit" class="btn btn-success" value="submit" onclick="isApprovedForAll()">
                            </td>
                        </tr>
                    </table>
                </div>
    ...
    function isApprovedForAll() {
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data)
                    swal({title: "True", icon: "success", button: "close"});
                else
                    swal({title: "False", icon: "error", button: "close"});
            }
        });
