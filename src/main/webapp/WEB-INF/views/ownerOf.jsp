    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <div class="list-group">
                ...
                <a href="/standard/ownerOf" class="list-group-item active">토큰 소유자 조회</a>
                ...
                <div class="card-body">
                    <table width="780">
                        <tr>
                            ...
                            <td align="right">
                                <input type="submit" class="btn btn-success" value="submit" onclick="ownerOf()">
                            </td>
                        </tr>
                    </table>
                </div>
