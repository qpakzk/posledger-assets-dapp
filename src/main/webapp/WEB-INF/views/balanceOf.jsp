    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <div class="list-group">
                ...
                <a href="/standard/balanceOf" class="list-group-item active">토큰 개수 조회</a>
        ...
        <div class="col-lg-9">
            <div class="card card-outline-secondary my-4">
                <div class="card-header">
                    <h1>토큰 개수 조회</h1>
                    <h2>표준 SDK의 balanceOf 함수</h2>
                </div>
                <div class="card-body">
                    <table width="780">
                        <tr>
                            <td>
                                사용자 ID: <input type="text" id="ownerId">
                            </td>
                            <td align="right">
                                <input type="submit" class="btn btn-success" value="submit" onclick="balanceOf()">
                            </td>
                        </tr>
                    </table>
                </div>
