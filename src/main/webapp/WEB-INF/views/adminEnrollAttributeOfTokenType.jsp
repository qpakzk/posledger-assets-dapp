    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <div class="list-group">
                ...
                <a href="#" class="list-group-item active">토큰 타입 속성 등록</a>
        ...
        <div class="card card-outline-secondary my-4">
            <div class="card-header">
                <h1>Enroll Attribute Of Token Type </h1>
            ...
            <div class="card-body" algin="right">
                ...
                <table width="780">
                    <tr>
                        ...
                        <td align="right">
                            <input type="submit" class="btn btn-success" value="submit" onclick="enrollAttributeOfTokenType()">
                        </td>
                    </tr>
                </table>
                <hr>
...
<script >
    ...
    function enrollAttributeOfTokenType() {
        ...
        $.ajax({
            type: "POST",
            url: "/enrollAttributeOfTokenType",
            data: {
                "ownerKey" : ownerKey,
                "xattrName" : xattrName,
                "xattrType" : xattrType,
